<template>
  ...
  >
    <div class="space-y-6">
      ...
      <div
        v-if="account"
        class="flex items-center justify-between rounded-xl border border-[var(--app-border)] bg-[rgba(255,255,255,0.02)] p-3"
      >
        <div class="flex items-center gap-3">
          <div class="stat-icon !h-10 !w-10">
            <Icon name="chartBar" size="md" class="text-[var(--app-text)]" />
          </div>
          <div>
      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-4">
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="stat-icon !h-8 !w-8 !rounded-md !text-base">
                <Icon name="dollar" size="sm" class="text-[var(--app-text)]" />
              </div>
            </div>
          ...
          <div class="card p-4">
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="stat-icon !h-8 !w-8 !rounded-md !text-base">
                <Icon name="bolt" size="sm" class="text-[var(--app-text)]" />
              </div>
            </div>
            <p class="text-2xl font-bold text-gray-900 dark:text-white">
          ...
          <div class="card p-4">
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="stat-icon !h-8 !w-8 !rounded-md !text-base">
                <svg
                  class="h-4 w-4 text-[var(--app-text)]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="stat-icon !h-8 !w-8 !rounded-md !text-base">
                <Icon name="clock" size="sm" class="text-[var(--app-text)]" />
              </div>
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="stat-icon !h-8 !w-8 !rounded-md !text-base">
                <Icon name="fire" size="sm" class="text-[var(--app-text)]" />
              </div>
              <span class="text-sm font-semibold text-gray-900 dark:text-white">{{
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="stat-icon !h-8 !w-8 !rounded-md !text-base">
                <Icon name="cube" size="sm" class="text-[var(--app-text)]" />
              </div>
              <span class="text-sm font-semibold text-gray-900 dark:text-white">{{
