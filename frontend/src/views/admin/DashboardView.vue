          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xs text-[var(--app-text-soft)]">
                  <span>{{ stats.normal_accounts }} {{ t('common.active') }}</span>
                  <span v-if="stats.error_accounts > 0" class="ml-1 text-[var(--app-danger)]"
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="flex-1">
                ...
                <div class="flex items-baseline gap-2">
                  ...
                  <span class="text-xs text-[var(--app-text-muted)]">RPM</span>
                </div>
                <div class="flex items-baseline gap-2">
                  <p class="text-sm font-semibold text-[var(--app-text-soft)]">
                    {{ formatTokens(stats.tpm) }}
                  </p>
                  <span class="text-xs text-[var(--app-text-muted)]">TPM</span>
                </div>
              </div>
            </div>
          </div>
