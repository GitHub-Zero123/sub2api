    ...
    <TablePageLayout>
      <template #actions>
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="stat-icon">
                <Icon name="document" size="md" class="text-[var(--app-text)]" />
              </div>
              <div>
                <p class="text-xs font-medium text-[var(--app-text-muted)]">
        ...
        <div class="card p-4">
          <div class="flex items-center gap-3">
            <div class="stat-icon">
              <Icon name="cube" size="md" class="text-[var(--app-text)]" />
            </div>
            <div class="min-w-0 flex-1">
              ...
              <p class="text-xs text-[var(--app-text-muted)]">
                ...
                <template v-if="cacheStats.totalInput > 0">
                  ...
                  <span>/</span>
                  <span class="text-[var(--app-text)]">{{ formatTokens(cacheStats.totalInput) }}</span>
        ...
        <div class="card p-4">
          <div class="flex items-center gap-3">
            <div class="stat-icon">
              <Icon name="dollar" size="md" class="text-[var(--app-text)]" />
            </div>
            <div class="min-w-0 flex-1">
              <p class="text-xs font-medium text-[var(--app-text-muted)]">
                {{ t('usage.totalCost') }}
        ...
        <div class="card p-4">
          <div class="flex items-center gap-3">
            <div class="stat-icon">
              <Icon name="clock" size="md" class="text-[var(--app-text)]" />
            </div>
            <div>
              <p class="text-xs font-medium text-[var(--app-text-muted)]">
                {{ t('usage.avgDuration') }}
              ...
              <p class="text-xs text-[var(--app-text-muted)]">{{ t('usage.perRequest') }}</p>
            </div>
          </div>
        </div>
        </div>
